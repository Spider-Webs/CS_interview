...
<a href="#ofive">16. 제네릭에 대해 설명해주시고, 왜 쓰는지 알려주세요.  </a><br><br>
...
또한 장점으로는
<ul>
<li>타입 안정성 제공 합니다 컴파일 타임에 타입 체크를 하기 때문에 런타임에서 ClassCastException과 같은 UncheckedException을 보장받습니다</li>
<li>타입체크와 형변환 생략 가능합니다 </li>
